...
model = neuralnet.MLP_MNIST(input_nodes=784, h1_nodes=h1_nodes, h2_nodes=h2_nodes, output_nodes=10, learning_rate=learning_rate)
...
model_test = neuralnet.MLP_MNIST(input_nodes=784, h1_nodes=h1_nodes, h2_nodes=h2_nodes, output_nodes=10, learning_rate=learning_rate)
